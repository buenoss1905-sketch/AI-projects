...
|---|---|---|
| [FinancialDetective](FinancialDetective/) | CSV masraf kayıtlarını JSON'da tanımlı şirket politikalarına ("skill") göre denetler, ihlalleri raporlar. 27 birim testi | pandas, Streamlit, pytest |
